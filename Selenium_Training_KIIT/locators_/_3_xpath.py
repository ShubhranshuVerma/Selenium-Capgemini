...
# driver = webdriver.Chrome(opts)
#
# driver.get(r'/Users/shubhranshuverma/PycharmProjects/Selenium_Training_KIIT/files/css_selector.html')
# time.sleep(2)
#
...
# time.sleep(2)
#
# driver.find_element('xpath', '(//input[@type="text"])[1]').send_keys('Shubh')
# time.sleep(1)
# driver.find_element('xpath', '(//input[@type="text"])[2]').send_keys('shubh@gmail.com')
# time.sleep(1)
# driver.find_element('xpath', '(//input[@type="text"])[3]').send_keys('9087654321')
