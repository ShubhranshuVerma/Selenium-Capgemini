...
# time.sleep(2)
# driver.find_element('css selector', 'input[type="text"]').send_keys("Shubh")
# time.sleep(1)
# driver.find_element('css selector', 'input[type="text"]').send_keys('shubh@gmail.com')
#
# #####################################################################
#
# # ##DRAWBACKS of CSS Selector:
# # 1. If there are multiple occurences , CSS selector chooses first occurance only (will concat the inputs if passed multiple times).
# # 2. Having attributes is a must as it cant locate the texts.
# # """
