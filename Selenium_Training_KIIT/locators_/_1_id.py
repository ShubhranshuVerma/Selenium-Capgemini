...
# time.sleep(2)
# driver.find_element('id', 'name').send_keys("Shubh")
# time.sleep(1)
# driver.find_element('id', 'email').send_keys('shubh@gmail.com')
# time.sleep(1)
# driver.find_element('id', 'phone').send_keys('9012345678')
# time.sleep(1)
# driver.find_element('id', 'textarea').send_keys('Bhubaneshwar')
# time.sleep(1)
